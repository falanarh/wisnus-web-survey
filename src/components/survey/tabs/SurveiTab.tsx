        ...
        {surveyQuestions.map((question, idx) => (
          <React.Fragment key={question.code}>
            <QuestionComponent 
              ...
              darkMode={darkMode} 
            />
            {/* Tambahkan tombol submit mobile setelah pertanyaan terakhir */}
            {idx === surveyQuestions.length - 1 && (
              <div className="md:hidden mt-8 flex justify-center">
                <button
                  className="w-full py-3 rounded-md transition font-semibold shadow-md bg-teal-400 dark:bg-teal-600 hover:bg-teal-500 dark:hover:bg-teal-500 text-white"
